#!/bin/bash
pushd misc
openssl enc -pbkdf2 -aes-256-cbc -salt -d -in testapp.mobileprovision.enc -out testapp.mobileprovision -pass pass:$APPLE_DEV_CERT_PWD
...
cp testapp.mobileprovision ~/Library/MobileDevice/Provisioning\ Profiles/
